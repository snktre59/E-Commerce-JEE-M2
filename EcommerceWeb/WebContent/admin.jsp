							...
							<c:forEach items="${commandes}" var="p">
								<div class="row">
									...
									<div class="row">
										...
										<span class="col-md-7" style="font-weight:bold">Désignation</span>
										<span class="col-md-1" style="font-weight:bold">Quantité</span>
	...
	<script type="text/javascript">
		function afficher(id) {
			if (document.getElementById(id).style.display == "none") {
				...
				document.getElementById('B' + id).innerHTML = 'Cacher le détail';
			} else {
				document.getElementById(+id).style.display = "none";
				document.getElementById('B' + id).innerHTML = 'Voir le détails';
			}
			return true;
		}
	</script>
